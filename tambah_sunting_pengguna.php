...
<main class="bg-danger pt-5 pb-5" style="margin-top: 140px; margin-bottom: 100px;"> 
        ...
        <div class="container">
                ...
                <div class="row">
                        <div class="col-md-12">
                            <label for="name" class="form-label fw-bold fs-30 text-black">Nama Lengkap Pengguna (wajib diisi): </label>
                            <input type="text" name="name" id="name" class="form-control" required value="<?php echo isset($_GET['id-pengguna']) ? $row_edit['name'] : ''; ?>">
                        </div> 
                </div>
                <div class="row">
                        <div class="col-md-12">
                            <label for="email" class="form-label fw-bold fs-30 text-black">E-mail (Surel) Pengguna (wajib diisi): </label>
                            <input type="email" name="email" id="email" class="form-control" required value="<?php echo isset($_GET['id-pengguna']) ? $row_edit['email'] : ''; ?>">
                        </div> 
                </div>
                <div class="row">
                        <div class="col-md-12">
                            <label for="password" class="form-label fw-bold fs-30 text-black">Password (Kata Sandi) Pengguna (wajib diisi): </label>
                ...
                <div class="row">
                        <div class="col-md-12">
                            <label for="profile_picture" class="form-label fw-bold fs-30 text-black">Foto Profil Pengguna (wajib diisi): </label>
                            ...
                            <?php if (isset($_GET['id-pengguna'])) { ?>
                                <small class="text-black">Nama file sebelumnya: <?php echo $row_edit['profile_picture']; ?></small><br>
                ...
                <div class="row mb-2">
                        <div class="col-md-12">
                            <label for="role" class="form-label fw-bold fs-30 text-black">Peran Pengguna (wajib dipilih): </label>
