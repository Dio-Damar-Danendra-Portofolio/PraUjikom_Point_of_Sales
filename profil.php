...
<main class="bg-info pt-5 pb-5" style="margin-top: 140px; margin-bottom: 100px;"> 
        ...
        <div class="container">
                ...
                <div class="col-lg-6">
                    <div class="text-end">
                        <a href="sunting_profil.php" class="btn btn-info btn-md">Edit Profil</a>
                    </div>
                </div>
                </div>
                <div class="row mt-2">
                    ...
                    <div class="col-xl-6 text-light">
                        ...
                        <p><span class="fw-bold">E-mail: </span> <?php echo isset($_SESSION['EMAIL']) ? htmlspecialchars($_SESSION['EMAIL']) : 'Belum memiliki e-mail'; ?>        
                    </p>
                    </div>
                </div>
        </div>
